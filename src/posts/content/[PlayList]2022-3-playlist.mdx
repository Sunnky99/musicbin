...
<VideoChange videoType={"video"} youLink={"TvnYmWpD_T8"} bilLink={"BV1Sk4y1q7tw"} imgLink={"https://files.seeusercontent.com/2026/07/05/4fxQ/screenshot-PrincePurple_Rain_vid.jpeg"} info={{title:"Purple Rain"}}/>
...
<VideoChange videoType={"video"} bilLink={"BV1uE41147XP"} info={{title:"加州旅馆"}}/>




<VideoChange videoType={"video"} bilLink={"BV1VK411u7vy"} info={{title:"皇后乐队蒙特利尔现场演唱会"}}/>
